...
- (void)dzn_invalidate
{
	...
	BOOL enable = YES;
	if([self.emptyDataSetDelegate respondsToSelector:@selector(emptyDataSetInvalidateShouldEnableScroll:)]){
		enable = [self.emptyDataSetDelegate emptyDataSetInvalidateShouldEnableScroll:self];
	}
